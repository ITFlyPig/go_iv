...
import com.pokemongo.ivgocalculator.PoGoApplication;
...
public class GoogleBillingUtil {
    ...
    public static String[] SUB_IDS = new String[]{"android.test.purchased"};
    public String[] inAppSKUS = new String[]{};//内购ID,必填
    public String[] subsSKUS = new String[]{"android.test.purchased"};//订阅ID,必填
    ...
    private static final String BASE_64_ENCODED_PUBLIC_KEY = "";
    ...
    public GoogleBillingUtil build() {
        if (mBillingClient == null) {
            synchronized (mGoogleBillingUtil) {
                Log.d("tt", "BaseApplication.getInstance(): " + PoGoApplication.getApplication());
                if (mBillingClient == null) {
                    if (isGooglePlayServicesAvailable(PoGoApplication.getApplication())) {
                        builder = BillingClient.newBuilder(PoGoApplication.getApplication());
    ...
    public void purchaseSubs(Activity activity, String skuId) {
        EventBus.getDefault().post(new GoogleBillingHelper.PayModel(GoogleBillingHelper.Event.START_SUB));//开始订阅
    ...
    private void purchase(Activity activity, final String skuId, final String skuType) {
        ...
        if (startConnection()) {
            BillingFlowParams flowParams = BillingFlowParams.newBuilder()
                    ...
                    .setType(skuType)
                    .build();
            Log.i(TAG, "purchase：skuId：" + skuId + "  skuType：" + skuType);
