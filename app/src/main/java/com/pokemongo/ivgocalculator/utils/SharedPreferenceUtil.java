...
public class SharedPreferenceUtil {
    ...
    public static void setStringDataIntoSP(String spName, String keyStr, String valueStr) {
    	SharedPreferences sp = PoGoApplication.getApplication().getSharedPreferences(spName, MODE_PRIVATE);
    ...
    public static void setBooleanDataIntoSP(String spName, String keyStr, Boolean valueStr) {
    	SharedPreferences sp = getApplcation().getSharedPreferences(spName, MODE_PRIVATE);
...
//    }
    ...
    public static int getIntValueFromSP(String spName, String keyStr) {
    	return getIntValueFromSP(spName, keyStr, -1);
    }
...
//    }
	...
	public static void setBooleanDataIntoSP(String keyStr, Boolean valueStr) {
		SharedPreferences sp = getApplcation().getSharedPreferences(SP_NAME, MODE_PRIVATE);
		sp.edit().putBoolean(keyStr, valueStr).commit();
	}


	public static boolean getBooleanValueFromSP( String keyStr) {
		return getBooleanValueFromSP(SP_NAME, keyStr, false);
	}
	...
	public static Long getLongValueFromSP(String keyStr) {
		return getLongValueFromSP(SP_NAME, keyStr, 0l);
	}
	...
	public static String getStringValueFromSP(String keyStr) {
		return getStringValueFromSP(SP_NAME, keyStr, "");
	}
	
	
	private static Application getApplcation() {
		return PoGoApplication.getApplication();
	}
}
